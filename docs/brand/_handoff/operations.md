...
Source: the master operations workbook (12 sheets). This file is the canonical operational spec for the design system; every kit that renders an operational artifact must match the values here. Where the workbook's brand values (palette, tagline, naming) conflict with `readme.md`, **readme.md wins** — the workbook is superseded on identity, authoritative on operations.

---

## 1. Ecosystem

Three tiers under one umbrella, plus a commercial fourth:
...
**Weekly sailing, Miami.** Trident 512 commercial pontoon — USCG-certified 45–50 ft passenger pontoon, plush perimeter lounge seating, dual swim platforms, premium sound, shade canopy. **Max 40 passengers + crew.**

Destination: Haulover Sandbar. Total arc: **7 hours**, 11:00 → 18:00, plus optional Shore Leave from 19:00.
...
| 17:00–18:00 | Departure & Sunset Cruise | Top-3 picks submitted in app; **Radar locks 17:30**; Match of the Day announced | MC & App Tech Lead | Golden-hour melodic |
| 18:00–18:30 | Return to Dock | Sealed Captain's Log envelope issued; shuttle transfer | GM & Transport Lead | Chill-out outro |
| 19:00–late | Shore Leave Afterparty | Optional VIP afterparty at partner venue | Shore Leave Lead | Peak nightclub |

### Ratio and capacity — hard gate

Sales lock at **40 passengers**. Two permitted compositions:
...
| Product | Price | Includes | Vetting / caps |
| --- | --- | --- | --- |
...
Per sailing, and 90-day totals across 12 sailings.
...
| Charter, fuel & crew | 0 | −$3,500 | −$42,000 |
| Food & beverage | 0 | −$1,500 | −$18,000 |
| Staffing & entertainment | 0 | −$2,200 | −$26,400 |
| Insurance, licensing & legal | −$5,000 | −$1,000 | −$17,000 |
| Dating tech infrastructure | −$8,000 | −$400 | −$12,800 |
| Marketing & ads | −$6,000 | −$800 | −$15,600 |
| **Operating expenses** | −$19,000 | −$9,400 | −$131,800 |
| **Net operating profit** | −$19,000 | **$9,100** | **$90,200** |

Net operating margin ≈ **40.6%** over the first 90 days.

---

## 5. Sponsorship inventory

| Tier | Fee | Target categories | Onboard assets | Digital assets |
| --- | --- | --- | --- | --- |
| **Presenting Partner** | $10,000/mo | Premium spirits, lifestyle tech | Title naming, full bar takeover, VIP lounge banner | App splash screen, premier email placement |
| **Sandbar Hub Sponsor** | $4,000/mo | RTD cocktails, hydration | Ring raft naming, paddleboard wraps, floating bar | Challenge leaderboard banner |
| **Confessional Pod Sponsor** | $3,000/mo | Wellness, skincare, wearables | Booth backdrop logo, prep-station placement | Watermark on all downloaded confessional clips |
| **Shore Leave Partner** | $2,000/mo | Hospitality, dining, nightclub | Shuttle branding, dining voucher presentation | 1-click date reservation button on match screen |

Co-marketing rights scale with tier; the Presenting Partner is the only tier with footage rights in paid campaigns (plus 2 VIP passes/week).

---

## 6. Merch catalog

| SKU | Unit cost | Retail | Margin | Channel |
| --- | --- | --- | --- | --- |
...
Co-branding targets are named per SKU in the workbook (Onia/Vilebrequin, Slowtide/Dock & Bay, Chubbies/Melin, YETI/Hydro Flask, Luli Fama/Pitusa).

---

## 7. Procurement zones

Five zones, each with named equipment and a procurement model — sponsorship in-kind, product sponsorship, corporate procurement, media procurement, or direct printing.

- **Boarding Zone** — navy carpet runner, step-and-repeat backdrop, brass ship's bell, check-in iPads with ID scanners, espresso martini station.
- **Main Bar & Deck** — shatterproof acrylic drinkware (60 sets), premium spirits and mixers (6 cases/week).
- **Confessional Pod** — soundproofed booth, red LED LIVE light, vintage mic, pocket cinema camera with tally indicator.
- **Sandbar Zone** — 6 tandem paddleboards/kayaks, 15 ft floating ring raft hub with anchor system, 2 floating waterproof speakers.
- **Hydration Station** — SPF touch-up bars (2 stations), chilled electrolytes and cold-towel fridges (3 cases/week).
- **Sunset & Shore Leave** — gold-foil Captain's Log envelopes with wax seals (40 sets/week), VIP Sprinter shuttle.

---

## 8. Season calendar — 14 weeks, 12 sailings
...
## 9. Communications map — 10 triggers
...
One message per trigger. No reminder chains.

---

## 10. Legal & conduct

Ten enforceable clauses cover: USCG maritime passenger liability, water sports release, **affirmative verbal consent** (zero tolerance), immediate removal for non-consensual conduct (removal at guest expense, fees forfeit, permanent expulsion), anti-doxxing NDA, **$50,000 liquidated damages** per privacy breach, substance policy, Confessional media release with anonymity blur on request, general indemnification, and Florida maritime arbitration in Miami-Dade preserving anonymity.

### The Riviera Code — six guest-facing rules
...
Use these terms verbatim across product, marketing, and operations. Never substitute generic equivalents.
