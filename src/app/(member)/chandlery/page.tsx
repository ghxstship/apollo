...
import { ChandleryShop, type ShopOrderView, type ShopProduct } from "./shop";

export const metadata: Metadata = { title: "The Chandlery" };

export default async function ChandleryPage() {
