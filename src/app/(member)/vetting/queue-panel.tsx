...
export function QueuePanel({
  ...
  /* Waiting: in the line, never offered, still live. Outstanding: offered, not
     yet claimed, not yet lapsed. The two are counted separately because a
  ...
  return (
    <div className="vet-panel">
      ...
      <p className="vet-note">
        An offer writes once and stands for six hours. After that it lapses on the
        next read of the queue and passes to the next in line — no scheduler has
        to be up for that to be true.
      </p>
    </div>
  );
}
