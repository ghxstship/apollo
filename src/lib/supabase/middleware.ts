...
const PROTECTED = ["/home", "/manifest", "/activity", "/charter", "/membership/standing", "/open-deck", "/directory", "/threads", "/portal", "/account", "/card", "/inbox", "/you", "/live", "/shop", "/stub", "/regattas", "/tables", "/matches", "/agreements", "/kiosk", "/bridge", "/vetting", "/radar", "/show"];
